  ...
  return (
    <div className="container-fluid dsp-pricing-sec">
      ...
      <div className="container dsp-pricing-con">
        <PricingCard head="STAGING" price="$79 USD/monthly"  pos="20px" />
        <PricingCard head="DESIGN" price="$79 USD/Annualy" />
        <PricingCard head="STAGING & DESIGN" price="$79 USD/Annualy"  pos="20px" />
